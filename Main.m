function Solved = Main(Path, Images_test)
    ...
    features3 = zeros(Size-4, 768);
    features4 = zeros(Size-4, 59);
                       ...
                       if j-1>0 && Selected(i, j-1) == 1
                           for h=1: 1: Size-4
                               ...
                               if Filled(h) == 0
                                   ...
                                   temp=0;
                                   for k=1: 1: 768
                                     temp = temp + double(abs(double(Round3(i, j-1, k)) - double(features3(h, k))));
                                   end
                        ...
                        if i-1>0 && Selected(i-1, j) == 1 
                           for h=1: 1: Size-4
                               ...
                               if Filled(h) == 0
                                   ...
                                   temp=0;
                                   for k=1: 1: 768
                                     temp = temp + double(abs(double(Round3(i-1, j, k)) - double(features3(h, k))));
                                   end
                                   res3(h, 1) = res3(h, 1) + (1)*(temp/(3*width*height*2));
